...
class FaissVectorStore:
    ...
    def reconstruct_by_product_id(self, product_id: str) -> np.ndarray | None:
    ...
    def search(self, query_embedding: np.ndarray, top_k: int = config.TOP_K_RETRIEVE) -> list[dict]:
    ...
    def save(self, directory: Path = config.INDEX_DIR):
    ...
    @classmethod
    def load(cls, directory: Path = config.INDEX_DIR) -> "FaissVectorStore":
